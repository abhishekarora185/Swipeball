...
public class MineBehaviour : MonoBehaviour {
	...
	void Start () {
        ...
        {
            this.gameObject.GetComponent<Light>().color = Color.LerpUnclamped(Color.cyan, Color.magenta, SwipeballConstants.Effects.LightLerpInterval);
        }
	}
	...
	void OnCollisionEnter2D(Collision2D collision)
	{
		...
		if (this.isLethal && collision.gameObject.name == SwipeballConstants.EntityNames.Cleaver && CleaverBehaviour.powerLevel > 0)
		{
            ...
            cleaver.GetComponent<Rigidbody2D>().velocity = Vector3.zero;
